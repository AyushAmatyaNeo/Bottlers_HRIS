...
class DashboardRepository {
    ...
    public function fetchEmployeesBirthday($employeeId) {
        $sql = "
                SELECT EMP.*,
                  DSG.DESIGNATION_TITLE,
                  EFL.FILE_PATH,
                ...
                FROM
                  ...
                  AND EMP.RETIRED_FLAG                  = 'N'
                  AND EMP.STATUS                        = 'E'
          AND EMP.COMPANY_ID = (SELECT COMPANY_ID FROM HRIS_EMPLOYEES WHERE EMPLOYEE_ID = $employeeId)
                  UNION ALL
                  SELECT EMP.EMPLOYEE_ID,
                    EMP. FULL_NAME,
                    EMP.BIRTH_DATE,
          ...
          HRIS_COMPANY C,
                ...
                WHERE EMP.DESIGNATION_ID   = DSG.DESIGNATION_ID
                AND EMP.PROFILE_PICTURE_ID = EFL.FILE_CODE(+)
                AND EMP.COMPANY_ID          = C.COMPANY_ID
