...
class LeaveApproveRepository implements RepositoryInterface {
    ...
    public function fetchById($id) {
        $sql = "SELECT DISTINCT INITCAP(TO_CHAR(LA.START_DATE, 'DD-MON-YYYY')) AS START_DATE,
                ...
                AND (ELA.FISCAL_YEAR_MONTH_NO =
                  CASE
                    ...
                    WHERE LA.END_DATE BETWEEN FROM_DATE AND TO_DATE)
					WHEN l.is_monthly = 'N' THEN ELA.FISCAL_YEAR_MONTH_NO
                  END
