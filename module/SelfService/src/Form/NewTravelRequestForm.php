...
class NewTravelRequestForm{
     ...
     * @Annotation\Attributes({"id":"form-purpose","class":"form-control", "style":"    height: 50px; font-size:12px"})
     */
    public $purpose;
     ...
     * @Annotation\Attributes({"id":"form-recommendedRemarks","class":"form-control","style":"    height: 50px; font-size:12px"})
     */
