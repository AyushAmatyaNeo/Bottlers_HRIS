...
class NotificationEvents {
    ...
    const TRAVEL_ACCEPTED_THIRD = 90;
    const TRAVEL_ACCEPTED_FOURTH = 91;
    const TRAVEL_ACCEPTED_FIFTH = 92;
    const TRAVEL_APPROVE_SIXTH = 93;
    const TRAVEL_EXPENSE_APPROVE_ACCEPTED = 94;
